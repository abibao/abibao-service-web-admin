...
const schema = {
  ...
  serialize: {
    only: ['id', 'urn', 'type', 'position', 'question', 'description', 'tags', 'label', 'placeholder', 'addCustomOption', 'addCustomOptionLabel', 'multipleSelections', 'randomize', 'required', 'maxLength', 'minimum', 'maximum', 'choices', 'updatedAt', 'createdAt'],
